---
title : "VueTemplate Syntax"
excerpt : "VueTemplate Syntax"
toc : true
toc_sticky : true
toc_label : "VueTemplate Syntax"
categories:
- VueStudy
tags:
- [Vue, FrontEnd, Study]
...
- 실제 html 출력을 위해서는 [v-html](../../vuestudy/vuestudy-VueDirective#v-html) Directive를 사용해야 한다.
...
- vue는 모든 데이터 바인딩 내에 javascript 표현식 지원
	- 이중괄호 내부
	- 모든 [Vue-Directive](../../vuestudy/vuestudy-VueDirective) 속성 내부
- 하나의 단일 표현식만 가능
- 함수호출 가능
